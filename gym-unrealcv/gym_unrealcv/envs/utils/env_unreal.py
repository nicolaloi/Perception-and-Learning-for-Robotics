...
hardcoded = True
hardcoded_port = 9050  # copy here the port used by the simulation
...
class RunUnreal():
    ...
    def start(self, docker, resolution):
        ...
        print("IP:",  env_ip)
        print("Port:", port,"  /    Hardcoded:", hardcoded)
    ...
    def close(self):
        if self.use_docker:
            ...
            import signal
            print("Closing process", self.env.pid+1)
