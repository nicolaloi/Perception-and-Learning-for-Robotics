...
model = PPO2(CnnPolicy, env, verbose=1, tensorboard_log=PATH_tensorboard, full_tensorboard_log=True, gamma=0.99, learning_rate=0.0001)     # MlpPolicy, MlpLstmPolicy, MlpLnLstmPolicy, CnnPolicy, CnnLstmPolicy, CnnLnLstmPolicy 
